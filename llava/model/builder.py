...
def load_pretrained_model(model_path, model_base, model_name, load_8bit=False, load_4bit=False, device_map="auto", device="cuda", use_flash_attn=False, **kwargs):
    ...
    if 'longllava' in model_name.lower():
        ...
        model = LlavaJambaForCausalLM.from_pretrained(model_path, attn_implementation="flash_attention_2", use_mamba_kernels=True, quantization_config=quantization_config, **kwargs)
